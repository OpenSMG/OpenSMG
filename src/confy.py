"""
Confy: a dictionary backed by a json file.
serves as a replacement to ini/config files.
Use like any other dict, call .save() to save.
Initialize it with a filename,
the backing file will be created if it didn't previously exist,
        ...
        if os.path.isfile(self.filename):
            ...
            with open(self.filename) as f:
                try:
                    ...
                    # config existed in a corrupt state
                    self.store = {}
        else:
